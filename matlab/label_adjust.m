function [DATAout] = label_adjust(DATAin,OPTION)

% --- Adjust label for the problem  ---
%
%   [DATAout] = label_adjust(DATAin,OPTION)
%
%	Input:
%       DATAin.alvos = misfit labels for each sample - [cxN] or [1xN]
%       OPTION.lbl = adjusting option
